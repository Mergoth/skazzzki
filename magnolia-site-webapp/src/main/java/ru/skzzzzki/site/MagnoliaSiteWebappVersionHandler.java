...
import ru.skzzzzki.site.tasks.FolderBootstrapTask;
 ...
 */
public class MagnoliaSiteWebappVersionHandler extends ThemeVersionHandler {
    
    public MagnoliaSiteWebappVersionHandler() {
